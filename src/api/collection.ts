...
export type CollectOrderListResult = BasePageResponse<{
  id: string;
  orderNo: string; // 订单号
...
export type CollectOrderResult = BaseResponse<{
  id: string;
  orderNo: string; // 订单号
  mchOrderNo: string; // 商户单号
  customerOrderNo: string; // 平台单号
 ...
 * @description: 代收订单
 */
export function getCollectOrderList(params: any) {
  return http.request<CollectOrderListResult>(
    {
      url: "/collection/list",
      method: "POST",
      params,
 ...
 * @description: 代收订单详情
 */
export function getCollectOrder(params: any) {
  return http.request<CollectOrderResult>({
    url: "/collection",
    method: "POST",
    params,
  },
