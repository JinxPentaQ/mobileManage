<template>
  ...
  >
    <div class="card flex flex-col">
      ...
      <van-field v-model="requestParams.mchOrderNo" label="商户单号" placeholder="请输入商户单号" />
      <van-field
        v-model="requestParams.customerOrderNo"
        label="平台单号"
        placeholder="请输入平台单号"
      />
      <div class="flex items-center justify-around">
        <van-field v-model="requestParams.minAmount" placeholder="最小金额" />
        <div class="ml-3 mr-3">-</div>
        <van-field v-model="requestParams.maxAmount" placeholder="最大金额" />
      </div>
